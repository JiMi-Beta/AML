...
# X, y = load_data('../../dataset/magic/magic04.data.txt')
X, y = load_data('/data/s2434792/amlData/hyperopt_dataset/magic04.data.txt')
...
trials = Trials()
best = fmin(f, space4sgd, algo=rand.suggest, max_evals=500, trials=trials)
